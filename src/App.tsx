	...
	return (
		<>
			...
			<main className='w-full'>
				<div
					className={`container mx-auto mt-8 rounded-xl border p-10 px-4 shadow-2xl backdrop-blur-md backdrop-brightness-90 ${colors.border} ${colors.shadow}`}
				>
					<section className='flex w-full flex-row flex-wrap justify-between gap-16'>
						...
						<div className='flex flex-row flex-wrap justify-start gap-1'>
							<button
								onClick={handleClickUpercase}
								className={classNameUpercaseButton}
								type='button'
							>
								{t('button.uppercase')}
							</button>
